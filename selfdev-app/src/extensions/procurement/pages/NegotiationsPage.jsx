...
export default function NegotiationsPage() {
  ...
  return <div className="pr-stack"><div className="pr-section-heading"><div><h2>Переговоры</h2><p>Задания, очередь отправки, состояние диалогов и ожидаемые действия.</p></div>{canManageNegotiations && <RouterLinkButton to="/procurement/negotiations/new"><MessageSquare />Создать задание</RouterLinkButton>}</div><ListFilters filters={filters} onChange={setFilters} statuses={[{ value: 'READY', label: 'Готово к постановке' }, { value: 'QUEUED', label: 'В очереди' }, { value: 'ACTIVE', label: 'Отправляется' }, { value: 'WAITING_SUPPLIER', label: 'Ждём поставщика' }, { value: 'FOLLOW_UP_DUE', label: 'Нужен follow-up' }, { value: 'ESCALATED', label: 'Эскалация' }, { value: 'COMPLETE', label: 'Завершено' }, { value: 'STALE', label: 'Устарело' }]} placeholder="Поставщик, контакт, карточка или NEG-ID" />
