...
export class ProcurementErrorBoundary extends React.Component {
  ...
  render() {
    ...
    return <main className="procurement-shell pr-boundary"><AlertTriangle size={32} /><h1>Раздел закупок временно недоступен</h1><p>Ошибка изолирована внутри рабочего пространства. Остальные разделы приложения продолжают работать.</p><Button onPress={() => { this.setState({ error: null }); window.location.assign('/procurement') }}>Перезагрузить раздел закупок</Button></main>
  }
}
