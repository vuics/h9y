...
function Workspace() {
  ...
  return <div className="procurement-host"><div className="pr-host-menu"><Menubar /></div><main className="procurement-shell">
    ...
    <div className="pr-page"><Routes><Route index element={<OverviewPage />} /><Route path="requests" element={<RequestsPage />} /><Route path="requests/new" element={<CardFormPage />} /><Route path="requests/:requestId/edit" element={<CardFormPage />} /><Route path="requests/:requestId/rfq" element={<RFQPage />} /><Route path="requests/:requestId/echemi" element={<EchemiPage />} /><Route path="requests/:requestId" element={<RequestDetailPage />} /><Route path="suppliers" element={<SuppliersPage />} /><Route path="suppliers/new" element={<SupplierFormPage />} /><Route path="suppliers/:supplierId/capabilities/new" element={<SupplierCapabilityFormPage />} /><Route path="suppliers/:supplierId/contacts/new" element={<SupplierContactFormPage />} /><Route path="suppliers/:supplierId/contacts/:contactId/edit" element={<SupplierContactFormPage />} /><Route path="suppliers/:supplierId" element={<SupplierDetailPage />} /><Route path="negotiations" element={<NegotiationsPage />} /><Route path="negotiations/new" element={<NegotiationFormPage />} /><Route path="negotiations/:negotiationId" element={<NegotiationDetailPage />} /><Route path="proposals" element={<ProposalsPage />} /><Route path="proposals/compare" element={<ProposalComparisonPage />} /><Route path="proposals/:proposalId" element={<ProposalDetailPage />} /><Route path="escalations" element={<EscalationsPage />} /><Route path="activity" element={<ActivityPage />} /><Route path="*" element={<Navigate to="/procurement" replace />} /></Routes></div>
  </main></div>
}
