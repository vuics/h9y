        ...
        email: {
          ...
          properties: {
            ...
            messageFormat: {
              ...
              enum: ['human', 'json'],
              default: 'human',
              description: 'Use JSON when the recipient is an agent that needs sender identity, conversation IDs, direction and attachment metadata. Human mode sends readable text without the machine envelope.',
            },
          },
        },
      },
        ...
        whatsapp: {
          ...
          properties: {
            ...
            messageFormat: {
              ...
              enum: ['human', 'json'],
              default: 'human',
              description: 'Use JSON for negotiator agents so the bridge includes the sender phone number, conversation ID, message direction and attachment metadata.',
            },
          },
        },
      },
        ...
        baileys: {
          ...
          properties: {
            ...
            messageFormat: {
              ...
              enum: ['human', 'json'],
              default: 'human',
              description: 'Use JSON for negotiator agents so the bridge includes the sender phone number, WhatsApp conversation ID, message direction and attachment metadata.',
            },
          },
        },
      },
