...
export const PROCUREMENT_ENDPOINTS = [
  ...
  { method: 'GET', path: '/campaigns/{campaign_id}' },
  ...
  { method: 'POST', path: '/campaigns/{campaign_id}/marketplace/{card_id}/resend' },
  { method: 'POST', path: '/campaigns/{campaign_id}/members' },
  ...
  { method: 'POST', path: '/campaigns/{campaign_id}/review/prepare' },
  { method: 'POST', path: '/campaigns/{campaign_id}/settings' },
  { method: 'POST', path: '/campaigns/{campaign_id}/unpause' },
  ...
  { method: 'POST', path: '/communication/compositions/{composition_id}/channel' },
  { method: 'POST', path: '/communication/compositions/{composition_id}/edit' },
  ...
  { method: 'POST', path: '/negotiations/{negotiation_id}/automation' },
  { method: 'POST', path: '/negotiations/{negotiation_id}/card-change/draft' },
  { method: 'POST', path: '/negotiations/{negotiation_id}/card-change/resolve' },
  { method: 'POST', path: '/negotiations/{negotiation_id}/channel' },
  { method: 'POST', path: '/negotiations/{negotiation_id}/drafts' },
  { method: 'POST', path: '/negotiations/{negotiation_id}/follow-up' },
  { method: 'POST', path: '/negotiations/{negotiation_id}/messages/{communication_id}/translation' },
  ...
  { method: 'POST', path: '/sourcing/{run_id}/contacts/stop' },
